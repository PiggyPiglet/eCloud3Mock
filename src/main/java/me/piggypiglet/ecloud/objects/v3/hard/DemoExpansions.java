...
public final class DemoExpansions {
    ...
    public static final Expansion BUKKIT_EXPANSION = expansion("bukkit meh", Platform.BUKKIT);
    public static final Expansion SPONGE_EXPANSION = expansion("moist sponge", Platform.SPONGE);
    public static final Expansion NUKKIT_EXPANSION = expansion("pe bukkit", Platform.NUKKIT);
    public static final Expansion UNIVERSAL_EXPANSION = expansion("the future", Platform.UNIVERSAL);

    private static Expansion expansion(String name, Platform platform) {
